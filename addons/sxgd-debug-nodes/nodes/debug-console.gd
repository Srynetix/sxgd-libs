...
const SxUi := preload("res://addons/sxgd-core/extensions/ui.gd")
const SxColor := preload("res://addons/sxgd-core/extensions/color.gd")
const SxNode := preload("res://addons/sxgd-core/extensions/node.gd")

const SxAutocompleteLineEdit := preload("res://addons/sxgd-ui-nodes/nodes/autocomplete-line-edit.gd")
const AutocompletionItem := SxAutocompleteLineEdit.AutocompletionItem
const SxDebugConsoleLineEdit := preload("res://addons/sxgd-debug-nodes/nodes/debug-console-line-edit.gd")
const SxCVars := preload("res://addons/sxgd-core-nodes/nodes/cvars.gd")

const _FONT := preload("res://addons/sxgd-ui-nodes/assets/fonts/OfficeCodePro-Regular.otf")

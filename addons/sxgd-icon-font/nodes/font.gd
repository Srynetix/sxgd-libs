...
const FASolidFont := preload("res://addons/sxgd-icon-font/assets/otfs/Font Awesome 6 Free-Solid-900.otf")
const FARegularFont := preload("res://addons/sxgd-icon-font/assets/otfs/Font Awesome 6 Free-Regular-400.otf")
const JsonData := preload("res://addons/sxgd-icon-font/nodes/json-data.gd")
